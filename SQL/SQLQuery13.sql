...
job_title varchar(20),min_salary money,max_salary money);

create table DEPARTMENTS(department_id int not null primary key,department_name varchar(10),
...
create table LOCATIONS(location_id int,street_address varchar(50),
postal_code int,city varchar(20),state_province varchar(10),country_id int);
